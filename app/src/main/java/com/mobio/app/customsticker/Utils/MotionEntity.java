...
public abstract class MotionEntity {
    ...
    private void drawSelectedBg(Canvas canvas) {
        ...
        //if(HomeActivity.text_connect){
        Log.e("Text Entity",""+HomeActivity.text_connect);
        canvas.drawBitmap(HomeActivity.deleteBitmap, null, HomeActivity.dst_delete, null);
        canvas.drawBitmap(HomeActivity.resizeBitmap, null, HomeActivity.dst_resize, null);
        canvas.drawBitmap(HomeActivity.resizeBitmap1, null, HomeActivity.dst_resize1, null);
        /*}else{
            Log.e("Text Entity","Not "+HomeActivity.text_connect);
            canvas.drawBitmap(ImageEntity.deleteBitmap, null, ImageEntity.dst_delete, null);
            canvas.drawBitmap(ImageEntity.resizeBitmap, null, ImageEntity.dst_resize, null);
        }*/
